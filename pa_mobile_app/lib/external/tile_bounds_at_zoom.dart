...
class InfiniteTileBoundsAtZoom extends TileBoundsAtZoom {
  ...
  @override
  Iterable<TileCoordinates> validCoordinatesIn(DiscreteTileRange tileRange) => tileRange.coordinates;
...
class WrappedTileBoundsAtZoom extends TileBoundsAtZoom {
  ...
  @override
  String toString() => 'WrappedTileBoundsAtZoom($tileRange, $wrappedAxisIsAlwaysInBounds, $wrapX, $wrapY)';
}
