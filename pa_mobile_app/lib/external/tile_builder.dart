...
typedef TileBuilder = Widget Function(BuildContext context, Widget tileWidget, TileImage tile);
...
Widget coordinateDebugTileBuilder(
  ...
  final readableKey = '${coordinates.x.floor()} : ${coordinates.y.floor()} : ${coordinates.z.floor()}';
