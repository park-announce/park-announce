...
class Marker {
  ...
  }) : anchor = anchorPos == null ? null : Anchor.fromPos(anchorPos, width, height);
}
...
class MarkerLayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (final marker in markers) {
      ...
      if (!map.pixelBounds
          .containsPartialBounds(Bounds(Point(pxPoint.x + leftPortion, pxPoint.y - bottomPortion), Point(pxPoint.x - rightPortion, pxPoint.y + topPortion)))) {
        continue;
      }
