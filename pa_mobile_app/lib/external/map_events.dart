  ...
  static MapEventWithMove? fromSource({
    ...
    String? id,
      ...
      switch (source) {
        ...
        MapEventSource.doubleTapZoomAnimationController => MapEventDoubleTapZoom(
            oldCamera: oldCamera,
            camera: camera,
            source: source,
          ),
        ...
        MapEventSource.onDrag || MapEventSource.onMultiFinger || MapEventSource.mapController || MapEventSource.custom => MapEventMove(
            id: id,
            oldCamera: oldCamera,
            camera: camera,
            source: source,
